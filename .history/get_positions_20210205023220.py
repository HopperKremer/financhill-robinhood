...
print(r['securitiesAccount']['orderStrategies'])
# for order in r['securitiesAccount']['orderStrategies']:
#     order_id = int(order['orderId'])
#     print('Canceling order for ' + order['quantity'] + " shares of " + order['orderLegCollection']['instrument']['symbol'])
