...
while i < 10:
    ...
    print(equity_buy_market(tickers[i].text, 1)
...
{'session': 'SEAMLESS', 'duration': 'GOOD_TILL_CANCEL', 'orderType': 'MARKET', 'orderLegCollection': [{'instruction': 'BUY', 'instrument': {'assetType': 'EQUITY', 'symbol': 'SVM'}, 'quantity': 1}], 'orderStrategyType': 'SINGLE'}